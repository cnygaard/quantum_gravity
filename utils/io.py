...
class QuantumGravityIO:
    ...
    def load_evolution_history(
        ...
        try:
            ...
            logging.info(
                f"Successfully loaded evolution history from {filepath}"
                )
    ...
    def save_measurements(self,
        ...
        try:
            ...
            data = {
                ...
                'measurements': [
                    {
                        'value': self._convert_to_serializable(
                            m.value
                            ),
                        'uncertainty': self._convert_to_serializable(
                            m.uncertainty
                            ),
                        'metadata': m.metadata
                    }
    ...
    def load_measurements(
            self,
            filename: str
            ) -> Tuple[List['MeasurementResult'], Dict]:
        ...
        try:
            ...
            measurements = [
                MeasurementResult(
                    ...
                    uncertainty=self._convert_from_serializable(
                        m['uncertainty']
                        ),
                    metadata=m['metadata']
                )
